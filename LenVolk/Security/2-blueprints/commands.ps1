...
$blueprint = New-AzBlueprint -Name "DemoBluePrint" -BlueprintFile "Blueprint.json"
...
New-AzBlueprintAssignment -Name "LenVolkBluePrintDemo" -Blueprint $blueprint -AssignmentFile ".\BlueprintAssignment.json"
