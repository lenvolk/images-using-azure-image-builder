...
$TemplateJSON | ConvertTo-Json -Depth 4 | Out-File "AIB-Choco.json" -Encoding ascii
...
az image builder create -g $aibRG -n $imageName --image-template AIB-Choco.json
